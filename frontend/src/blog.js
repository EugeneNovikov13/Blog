...
export const Blog = () => {
	//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	//такой запрос по умолчанию невозможен из-за политики безопасности браузера
	//можно либо изменить настройки сервера, либо настроить проксирование
	//для этого нужно добавить в package.json поле "proxy" строку: "http://localhost:3001", и убрать её в fetch
	// useLayoutEffect(() => {
	// 	fetch('/posts')
	// 		.then(res => res.json())
	// 		.then(console.log)
